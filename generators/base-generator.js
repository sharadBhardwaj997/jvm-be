...
w
    ...
    _formatCode(configOptions, baseDir,cli) {
        if (configOptions.buildTool === 'maven') {
            this._formatCodeMaven(configOptions, baseDir,cli);
        } else {
            this._formatCodeGradle(configOptions, baseDir, cli);
        }
    }

    _formatCodeMaven(configOptions, baseDir,cli) {
        if(cli)  {
    ...
    _formatCodeGradle(configOptions, baseDir,cli) {
        if(cli)  {
